# This is the 2-commodity,  3-node version that tries to capture all of the output into a single log file
...
print("Script completed. All output logged to 'output.txt' and CSVs for graphing.")